  ...
  <div class="h-full flex flex-col items-center justify-center">
    ...
    <div class="text-center space-y-16 w-full">
      ...
      <div class="flex items-baseline justify-center">
        <span class="text-gray-400 text-lg md:text-xl font-medium mr-2 md:mr-4" v-if="store.token">剩余</span>
        <span class="text-7xl md:text-[9rem] font-light leading-none tracking-tighter text-gray-900 font-sans" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
          {{ store.token ? remainingDays : 30000 }}
        </span>
        <span class="text-gray-400 text-lg md:text-xl font-medium ml-2 md:ml-4">天</span>
      </div>
      ...
      <div class="max-w-md mx-auto pt-8">
        <p class="text-gray-500 text-sm md:text-base leading-relaxed italic px-4">
          “{{ quote }}”
        </p>
      </div>
    </div>
